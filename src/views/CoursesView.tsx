...
export const CoursesView: React.FC<CoursesViewProps> = ({
  ...
  return (
    <div className="w-full max-w-7xl mx-auto pb-24 md:pb-12 p-3 sm:p-4 md:p-6 lg:p-8 animate-in fade-in duration-200">
      {/* Responsive Grid: Full-width on iPad portrait, Dual-Pane on iPad landscape & Laptop */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6 items-start">
        ...
        {/* Right Sidebar Column (4 cols on iPad landscape & Laptop): Playlist & Faculty Widget */}
